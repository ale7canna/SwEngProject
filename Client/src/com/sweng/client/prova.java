...
public class prova {
	...
	/*public ArrayList<CheckBoxId> createCheckboxList(ArrayList<User> lista){
		...
		for (User u : lista){
			...
			checkbox = new CheckBoxId(u.getIdUser());
	...
	*/
	...
	public static ArrayList<CheckBoxId> createCheckboxList(ArrayList<Integer> lista, ArrayList<String> stringa){
		ArrayList<CheckBoxId> listacheckbox = new ArrayList<CheckBoxId>();
		Iterator<Integer> iterator = lista.iterator();
		Iterator<String> it1 = stringa.iterator();
		while (iterator.hasNext()||it1.hasNext()){
			
			int id = iterator.next();
			String nome = it1.next();
					
			
			checkbox = new CheckBoxId(id, nome);
	...
	/*public static void addPeople(ArrayList<Integer> intero, ArrayList<String> str){
		CheckBoxId ckId;
		while(intero.iterator().hasNext()&& str.iterator().hasNext()){
			List l = new List();
			
			l.add(String.valueOf(intero.iterator().next()));
			l.add(str.iterator().next());
			l.add(new Boolean(null));
